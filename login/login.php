        ...
        <div class="col-lg-6" id="new-login-form-container">
            ...
            <form method="post" action="../includes/login.inc.php">
                ...
                <div class="form-group" style="border: 1px solid var(--wild-blue-yonder);border-radius: 0.25rem;margin-top: 5%;">
                    <select name="languages" id="languages" aria-label="language selection" class="translate form-control border-1px-wild-blue-yonder" onchange="setLanguage()">
                ...
                <div style="display: flex; justify-content: space-between; font-size: 10px">
                    <div class="form-group remember-info" >
                        <input type="checkbox" id="login-rememberInformation" name="rememberInformation">
                        <label class="translate roboto-normal-black-9px-2" data-key="rememberInformation" for="login-rememberInformation">Remember Information</label>
                    </div>

                    <div class="form-group">
                        <a href="javascript:void(0)" onclick="forgotPassword()" class="translate roboto-normal-bahama-blue-9px-2" data-key="forgotPass"> Forgot Password? </a>
                    </div>
                </div>
                ...
                if (isset($_GET['success'])) {
                    if ($_GET['success'] === "sent") {
                        ...
                        echo "<p data-key='emailSent' class='message-text'>" . $successMsg . "</p>";
                    }
                }
                ?>
                ...
                if (isset($_GET["error"])) {
                    switch ($_GET["error"]) {
                        case 'emptyfields':
                            ...
                            echo '<p class="message-text translate" data-key="emptyfields" role="alert" aria-atomic="true">' . $errorMsg . '</p>';
                            break;
                        case 'incorrect':
                            $errorMsg = "Either your email or password was incorrect";
                            echo '<p class="message-text translate" data-key="incorrect" role="alert" aria-atomic="true">' . $errorMsg . '</p>';
                            break;
                        case 'external':
                            $errorMsg = "Something went wrong trying to retrieve your account";
                            echo '<p class="message-text translate" data-key="external" role="alert" aria-atomic="true">' . $errorMsg . '</p>';
                            break;
                        case 'passReset':
                            $errorMsg = "Error resetting password";
                            echo '<p class="message-text translate" data-key="resetError" role="alert" aria-atomic="true">' . $errorMsg . '</p>';
                            break;
                    }
                }
                ?>
