        ...
        <nav id="sidebar" style="z-index: 1;">
            ...
            <div class="close-btn">
                <div class="icon" id="sidebarCollapse">
                    <img src="images/sidebar-toggle.png" alt="sidebartoggle">
                </div>
            </div>
            <div class="list-unstyled">
                ...
                <div class="collapse-outer">
                    <div class="collapse-head" onclick="SwitchOverallDash()">
                        <div class="side-icon">
                            <img src="images/myDashboard.png" alt="my-dashboard">
                        </div>
                        <div class="titel-box">
                            <span>My Dashboard</span>
                            <img src="images/arrow.png" alt="my-dashboard">
                        </div>
                    </div>
                </div>
                <!-- My URL List -->
                <div class="collapse-outer">
                    <div class="collapse-head" data-toggle="collapse" data-target="#collapseExample2">
                        <div class="side-icon">
                            <img src="images/my-URL-list.png" alt="my-url-list">
                        </div>
                        <div class="titel-box">
                            <span class="translate" data-key="myURLList">My URL List </span>
                            <img src="images/arrow.png" alt="my-url-list">
                        </div>
                    </div>
                ...
                <div class="collapse-outer">
                    <div class="collapse-head" data-toggle="collapse" data-target="#my_profile_collapse">
                        ...
                        <div class="titel-box">
                            <span class="translate" data-key="myProfile">My Profile</span>
                            <img src="images/arrow.png" alt="my-profile">
                        </div>
                    </div>
                            ...
                            <div class="my-profile">
                                <div class="box2" onclick="changePassword()">
                                    <div class="box">
                                        ...
                                        <span class="translate" data-key="changePass">Change password</span>
                                    </div>
                                    <div class="box">
                                        <img src="images/arrow.png" alt="change-password">
                                    </div>
                                </div>
                                <div class="box2" data-toggle="collapse" data-target="#change_language">
                                    <div class="box">
                                        <i class="fa fa-envelope"></i>
                                        <span class="translate" data-key="changeLang">Change language</span>
                                    </div>
                                    <div class="box">
                                        <img src="images/arrow.png" alt="change-language">
                                    </div>
                                </div>
                                <div class="collapse" id="change_language">
                                    <div class="collapse-body">
                                        <ul>
                                            <li lang="da" onclick="updateLang('da')">
                                                <a href="#">
                                                    Dansk
                                                </a>
                                            </li>
                                            <li lang="de" onclick="updateLang('de')">
                                                <a href="#">
                                                    Deutsch
                                                </a>
                                            </li>
                                            <li lang="en" onclick="updateLang('en')">
                                                <a href="#">
                                                    English
                                                </a>
                                            </li>
                                            <li lang="es" onclick="updateLang('es')">
                                                <a href="#">
                                                    Español
                                                </a>
                                            </li>
                                            <li lang="fr" onclick="updateLang('fr')">
                                                <a href="#">
                                                    Français
                                                </a>
                                            </li>
                                            <li lang="it" onclick="updateLang('it')">
                                                <a href="#">
                                                    Italino
                                                </a>
                                            </li>
                                            <li lang="nl" onclick="updateLang('nl')">
                                                <a href="#">
                                                    Nederlands
                                                </a>
                                            </li>
                                ...
                                <div class="box2" id="inviteUser" v-if="client && client.isOwner" onclick="inviteNewUser()">
                                    <div class="box">
                                        <i class="fa fa-user"></i>
                                        <span class="translate" data-key="inviteUser">Invite user</span>
                                    </div>
                                    <div class="box">
                                        <img src="images/arrow.png" alt="invite-user">
                                    </div>
                                </div>
                                <div class="box2" id="backToAdmin" v-if="client && client.companyName === 'AbleDocs'" onclick="backToAdmin()">
                                    <div class="box">
                                        <i class="fa fa-home"></i>
                                        <span class="translate" data-key="backToAdmin">Back to admin</span>
                                    </div>
                                    <div class="box">
                                        <img src="images/arrow.png" alt="back-to-admin">
                                    </div>
                                </div>
                ...
                <div class="collapse-outer" onclick="logout()">
                    <div class="collapse-head">
                        ...
                        <div class="titel-box">
                            <span class="translate" data-key="logout">Log out</span>
                            <img src="images/arrow.png" alt="logout">
                        </div>
                    </div>
                </div>
            </div>
